...
{
	// Return MacRoman as the default encoding for classic Mac apps.
	// This is appropriate for most Western applications and is the most
	// common encoding used in Resource Manager resources.
